...
def findWinningBoard(boards, bingoNums):
    ...
    for idx,winningNumOfCalls in enumerate(wins):
        if winningNumOfCalls < min:
            min = winningNumOfCalls
            minIdx = idx
        print(winningNumOfCalls, idx, min, minIdx)
    return (minIdx, min)
...
#print(boards[winningBoardIdx])
#print(winningBoardIdx)
#print(getWinningIndices(boards, bingoNums))
#print(winningCallIdx)
print(bingoNums[:winningCallIdx+1])
